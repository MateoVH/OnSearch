...
namespace OnSearch.Web.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(DataContext context, BlobHelper blobHelper, CombosHelper combosHelper, ConverterHelper converterHelper)
        {
            _context = context;
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            Product unit = await _context.Products.Include(p => p.ProductImages).FirstOrDefaultAsync(p => p.Id == id);
